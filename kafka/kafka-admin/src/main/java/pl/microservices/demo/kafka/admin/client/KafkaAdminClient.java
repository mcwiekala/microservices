package pl.microservices.demo.kafka.admin.client;
...
import pl.microservices.demo.config.RetryConfigData;
import pl.microservices.demo.kafka.admin.exception.KafkaClientException;
...
public class KafkaAdminClient {
    ...
    private void sleep(Long sleepTimeMs) {
        try {
            ...
            throw new KafkaClientException("Error while sleeping for new created topic!");
        }
    }
