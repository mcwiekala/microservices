package pl.microservices.demo.config.pl.microservices.demo.kafka.consumer.config;
...
import pl.microservices.demo.config.KafkaConsumerConfigData;
...
public class KafkaConsumerConfig<K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> consumerConfigs() {
        ...
        props.put(ConsumerConfig.MAX_PARTITION_FETCH_BYTES_CONFIG, kafkaConsumerConfigData.getMaxPartitionFetchByBytesDefault()
                * kafkaConsumerConfigData.getMaxPartitionFetchByBytesBoostFactor());
